...
export function createStates(persona) {
    const goToIdle = () => persona.setState(StatesConsts.Idle);
    ...
    return {
        ...
        upset() {
            ...
            timeline.add(new TimelineMax()
                .to(persona._data.hsl, timeIn, { y: 0.2, ease: Power3.easeOut  })
                .to(persona._data.hsl, timeOut, { y: 0.73, delay: delayInOut, ease: Power3.easeOut  }),
             0);

            timeline.add(new TimelineMax()
                .to(persona._data, timeIn, { rotation: 1.5 + Math.random(), ease: Power3.easeOut  })
                .to(persona._data, timeOut, { rotation: 3, delay: delayInOut, ease: Power3.easeOut  })
                .add(() => { persona._data.rotation = 0; }),
             0);
        ...
        yes() {
            ...
            timeline.add(new TimelineMax()
                .to(persona._data, 2.4, { rotation: -1, ease: Power3.easeOut  })
                .to(persona._data, 0.8, { rotation: 0, ease: Power3.easeOut  })
                .add(() => { persona._data.rotation = 0; })
            , 0);
